...
mod tests {
    ...
    fn test_audit_log_record_all() {
        let mut log = AuditLog::new(100);
        let events = vec![
            AuditEvent::new("s1".to_string(), AuditSeverity::High, LeakageVector::OutputChannel, "e1".to_string()),
            AuditEvent::new("s2".to_string(), AuditSeverity::Warning, LeakageVector::ToolCall, "e2".to_string()),
        ];
    ...
    fn test_severity_ordering() {
        ...
        for severity in [AuditSeverity::Info, AuditSeverity::Warning, AuditSeverity::High, AuditSeverity::Critical] {
