...
mod tests {
    ...
    fn test_sanitize_clean_output() {
        ...
        let result = OutputSanitizer::sanitize(&registry, "Payment completed successfully.", "sess-1");
    ...
    fn test_contains_leakage() {
        ...
        assert!(OutputSanitizer::contains_leakage(&registry, "Card: 4111-1111-1111-1111"));
    }
